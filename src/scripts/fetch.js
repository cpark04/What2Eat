...
export class Fetch {
  ...
  findRecipeID(ingredientsArr){
    ...
    fetch(`https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?ingredients=${ingredients}&number=5&ignorePantry=true&ranking=1`, {
      "method": "GET",
      "headers": {
  ...
  getRecipeData(id){
    ...
    .then(response => response.json())
    .then((data) => util.getMealData(data))
    .catch(err => {
      console.error(err);
    });
  }
